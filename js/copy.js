...
for(i= 0; i < comicArray.length; i++) {
	...
	newBox.id = "box" + i;
	// console.log(newBox);
	// document.getElementById(boxArray[i].length).innerHTML
	// var sequence= document.getElementById("sequence")
	// var conditon= document.getElementById("condition")
	// var price= document.getElementById("price")
	// var display= document.getElementById("image")
	//may need to create img element if the code above does not work
